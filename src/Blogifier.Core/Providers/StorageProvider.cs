...
namespace Blogifier.Core.Providers
{
    public interface IStorageProvider
    {
        ...
        (bool found, string path) FindFolderInRoute(string contentRootPath, string target);
    }
    ...
    public class StorageProvider : IStorageProvider
    {
        ...
        public (bool found, string path) FindFolderInRoute(string contentRootPath, string target)
        {
            var directory = new DirectoryInfo(contentRootPath);
            do
            {
                var folder = Path.Combine(directory.FullName, target);
                if (Directory.Exists(folder)) return (true, folder);
